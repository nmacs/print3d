...
#define	X_MIN_PIN						PIN_DEF (PORT_B, 5)
//#define	X_MAX_PIN				        xxxx
#define	X_ENABLE_PIN					        PIN_DEF (PORT_A, 3)
//#define	X_INVERT_DIR
//#define	X_INVERT_MIN
//#define	X_INVERT_MAX
#define	X_INVERT_ENABLE

#define	Y_STEP_PIN						PIN_DEF (PORT_A, 4)
#define	Y_DIR_PIN						PIN_DEF (PORT_A, 5)
#define	Y_MIN_PIN					        PIN_DEF (PORT_B, 6)
//#define	Y_MAX_PIN				        xxxx
#define	Y_ENABLE_PIN					        PIN_DEF (PORT_A, 6)
//#define	Y_INVERT_DIR
//#define	Y_INVERT_MIN
//#define	Y_INVERT_MAX
#define	Y_INVERT_ENABLE

#define	Z_STEP_PIN						PIN_DEF (PORT_A, 7)
#define	Z_DIR_PIN						PIN_DEF (PORT_C, 4)
#define	Z_MIN_PIN						PIN_DEF (PORT_B, 7)
//#define	Z_MAX_PIN                                       xxxx
#define	Z_ENABLE_PIN					        PIN_DEF (PORT_C, 5)
//#define	Z_INVERT_DIR
//#define	Z_INVERT_MIN
//#define	Z_INVERT_MAX
#define	Z_INVERT_ENABLE

#define	E_STEP_PIN						PIN_DEF (PORT_B, 0)
#define	E_DIR_PIN					        PIN_DEF (PORT_B, 1)
#define E_ENABLE_PIN					        PIN_DEF (PORT_B, 2)
//#define	E_INVERT_DIR
...
#define BLUE_LED_PIN					        PIN_DEF (PORT_C, 8)
